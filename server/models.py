...
#     modifiers = relationship("Modifier", backref=backref("question", cascade="all, delete-orphan"))

# class Token(db.Model):
#     id = db.Column(db.Integer, primary_key=True)
#     name = db.Column(db.String(80), unique=True, nullable=False)
#     modifiers = relationship("Modifier", backref=backref("token", cascade="all, delete-orphan"))

# class Modifier(db.Model):
#     id = db.Column(db.Integer, primary_key=True)
#     yes_modifier: Column(db.Integer, unique=False, nullable=False)
#     no_modifier: Column(db.Integer, unique=False, nullable=False)
#     token_id: Column(db.Integer, ForeignKey('token.id'))
#     token = relationship(Token, 
#         backref=backref("modifiers", cascade="all, delete-orphan"))
#     question_id: Column(db.Integer, ForeignKey('question.id'))
